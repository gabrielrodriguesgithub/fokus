...
const paragrafoTaskAndamento = document.querySelector('.app__section-active-task-description')
    ...
    if(tarefa.completa){
        ...
        li.addEventListener('click', () => {
            ...
            if(tarefaSelecionada == tarefa) {
                paragrafoTaskAndamento.textContent = ''
            ...
            paragrafoTaskAndamento.textContent =  tarefa.descricao
